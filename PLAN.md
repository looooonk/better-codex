...
- [ ] Replace the placeholder dashboard with borderless, flat live panels for token usage, context-window pressure, rate limits, active turn status, and model/service tier.
