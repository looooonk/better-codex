...
- [ ] When swapping to the first or third tab via CTRL + 1 / CTRL + 3, the dashboard autofocuses. Stop this, and make CTRL + 1 / CTRL + 3 focus only when that pane is already brought up.
