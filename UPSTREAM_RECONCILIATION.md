...
| 1J | `2994f545` (#37132) | Local managed login-method and ChatGPT-workspace restrictions intersect without allowing cloud policy to widen bootstrap authentication | `just test -p codex-config` (212 passed), scoped fix, `just fmt` | Config model complete; credential/login enforcement pending |
