...
impl RmcpClient {
    ...
    async fn connect_pending_transport(
        ...
        // Preserve request-freshness behavior: rmcp 3 enables response caching
        // and stale-on-error fallback by default.
        service
            .peer()
...
async fn create_oauth_transport_and_runtime(
    ...
    let mut oauth_state = OAuthState::Unauthorized(authorization_manager);
