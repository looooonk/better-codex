...
#[derive(Debug, Parser)]
#[command(bin_name = "better-codex plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "better-codex plugin add",
    after_help = "Examples:\n  better-codex plugin add sample@debug\n  better-codex plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "better-codex plugin list",
    after_help = "Examples:\n  better-codex plugin list\n  better-codex plugin list --marketplace debug\n  better-codex plugin list --json\n  better-codex plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "better-codex plugin remove",
    after_help = "Examples:\n  better-codex plugin remove sample@debug\n  better-codex plugin remove sample --marketplace debug"
)]
