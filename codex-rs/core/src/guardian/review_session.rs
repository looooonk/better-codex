...
mod tests {
    ...
    #[tokio::test]
    async fn guardian_review_session_config_preserves_empty_catalog_policy_and_template() {
        let parent_config = crate::config::test_config().await;
        let model_messages = ModelMessages {
            instructions_template: None,
            instructions_variables: None,
    ...
    #[tokio::test]
    async fn guardian_review_session_config_falls_back_each_catalog_policy_part_independently() {
        let parent_config = crate::config::test_config().await;
        let model_messages = ModelMessages {
            instructions_template: None,
            instructions_variables: None,
